...
@Database(entities = [NoteEntity::class, BookEntity::class], version = 4, exportSchema = false)
abstract class NoteDatabase : RoomDatabase() {
    ...
    companion object {
        ...
        private val MIGRATION_3_4 = object : Migration(3, 4) {
            override fun migrate(database: SupportSQLiteDatabase) {
                database.execSQL("ALTER TABLE `notes` ADD COLUMN `mediaFiles` TEXT NOT NULL DEFAULT ''")
            }
        }
